...
starGeo.setAttribute("position", new THREE.BufferAttribute(new Float32Array(6*starsCount), 3));
starGeo.setAttribute("velocity", new THREE.BufferAttribute(new Float32Array(2*starsCount), 1));
